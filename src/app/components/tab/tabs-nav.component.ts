...
export class TabsNavComponent implements AfterContentChecked, AfterContentInit {
    ...
    @HostBinding('class.cherry-ui-tabs-bar') true;
    ...
    @Input()
    set uiHideBar(value: boolean) {
        this._hideBar = this.toBoolean(value);
    }

    get uiHideBar(): boolean {
    ...
    @Input()
    set uiShowPagination(value: boolean) {
        this._showPagination = this.toBoolean(value);
    }

    get uiShowPagination(): boolean {
        return this._showPagination;
    }

    @Input()
    set uiPositionMode(value: uiTabPositionMode) {
        this._tabPositionMode = value;
        this._alignInkBarToSelectedTab();
        if (this.uiShowPagination) {
            this._updatePagination();
        }
    }

    get uiPositionMode(): uiTabPositionMode {
