...
@Component({
    ...
    templateUrl: './linkageSearch.component.html',
    styleUrls: ['./linkageSearch.component.scss'],
...
export class LinkageSearchComponent implements OnInit {

    tableTitle: String = '级联查询';
