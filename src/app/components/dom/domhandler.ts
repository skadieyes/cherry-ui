...
export class DomHandler {
    ...
    public calculatedScrollbarWidth: number = null;
    ...
    public matches(element: any, selector: string): boolean {
        ...
        const f = p['matches'] || p.webkitMatchesSelector || p.msMatchesSelector || function (s: any) {
    ...
    calculateScrollbarWidth(): number {
        ...
        scrollDiv.className = 'cherry-ui-scrollbar-measure';
